...
# To read images it uses tessercat
# --> pip install pytesseract
# Download from https://github.com/tesseract-ocr/tesseract/wiki
# Run the installer, then add Tesseract’s folder to your system PATH.
# This modules requires Tessaract to be pre installed to run. 
# You must install the Tesseract OCR software separately on your system (the executable), which pytesseract then uses under the hood.
...
if __name__ == "__main__":
    ...
    for filename, text_content in extracted_texts.items():
        ...
        print(text_content[:])  # limit output to first 1000 chars
        print("\n" + "="*40 + "\n")
